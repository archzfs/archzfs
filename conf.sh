...
AZB_LINUX_VERSION_FULL="$LINUX_VERSION-$LINUX_PKGREL"

# Package version number
AZB_PKG_VERSION="${ZOL_VERSION}_${LINUX_VERSION}"
AZB_FULL_VERSION="$PKG_VERSION-$PKGREL"

# Archiso Configuration
AZB_LINUX_ARCHISO="3.12.6"
AZB_LINUX_ARCHISO_PKGREL="1"
AZB_ARCHISO_FULL_VERSION="${ZOL_VERSION}_${LINUX_ARCHISO}-$LINUX_ARCHISO_PKGREL"
